            ...
            <Jumbotron >
              <Container>
                ...
                <p>
                  ...
                  raised in Austin, Texas she has held a very healthy and active
                  lifestyle. She has integrated that healthy lifestyle in her
                  treatment room using holistic skincare and wellness practices.
                  She previously trained under a physician in Austin where she
                  experienced the medical side of Aesthetics. Having that
                  experience drove her towards her decision to step away from
                  lasers and chemical peels, and focus on healing the skin from
                  the inside-out. By using non-toxic skincare products and
                  treatments we can achieve ethical and permanent change without
                  damaging nor thinning your skin. In her free time you can
                  catch her playing outdoors with her son, walking town lake,
                  paddle boarding or checking out new local shops and
                  restaurants.
                </p>
              </Container>
            </Jumbotron>
          ...
          <Element name="VCElement">
            <Jumbotron>
              <Container>
                ...
                <Row>
                  <Button variant="outline-secondary">Book VC</Button>

                  <Button variant="outline-secondary">Skin Questionaire</Button>
                </Row>
              </Container>
            </Jumbotron>
          </Element>
